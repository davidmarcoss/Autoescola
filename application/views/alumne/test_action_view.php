    ...
    <div class="row">  
        <div class="col-lg-12 col-md-12">
            <form id="test-form">
                        ...
                        <div class="card-box">
                            <div class="col-md-9">
                                ...
                                <label for="o<?php echo $cont; ?>" class="radio-inline">
                                    <input type="radio" name="p[<?php echo $pregunta['codi']; ?>]" id="o<?php echo $cont; ?>" value="<?php echo $opcio; ?>" /> <?php echo $opcio; ?>
                                </label>
                                <br/><br/>
                                <?php $cont++ ?>
                                <?php endforeach; ?>
                ...
                <?php endforeach; ?>
                <button type="submit" class="btn btn-success btn-lg btn-block pull-right" id="btn-check-test">Acabar</button>
            </form>
        </div>
    </div>
</div>
...
<script>
    var site_url = "<?php echo site_url('TestsController/check'); ?>";
</script>
